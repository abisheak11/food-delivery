...
Write-Host "[0/5] Starting Kafka & Zookeeper containers..." -ForegroundColor Yellow
docker compose up -d zookeeper kafka

# Start Auth Service (8081)
Write-Host "[1/5] Starting Auth Service on port 8081..." -ForegroundColor Green
...
Write-Host "[2/5] Starting Order Service on port 8082..." -ForegroundColor Green
...
Write-Host "[3/5] Starting Restaurant Service on port 8083..." -ForegroundColor Green
...
Write-Host "[4/5] Starting Delivery Service on port 8084..." -ForegroundColor Green
...
Write-Host "[5/5] Starting API Gateway & Swagger Hub on port 8090..." -ForegroundColor Green
...
Write-Host "`nAll 5 services are launching in parallel!" -ForegroundColor Cyan
